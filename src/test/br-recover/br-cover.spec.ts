...
import { brRecoverTestCases } from "./testcase";
import { strictEqual } from "assert";
import { BR_RECOVER as mode } from "../../react/editor/process-mode/list";
...
describe("Image Replacer Mapper Mode", function () {
     ...
     */
    it("초기화", function () {
        strictEqual(mode.name, "BR_RECOVER");
    });

    /**
     * 각 테스트케이스를 실행
     */
    for (const testcase of brRecoverTestCases) {
